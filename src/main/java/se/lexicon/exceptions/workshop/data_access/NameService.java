...
public class NameService {
		...
		{
			if(femaleFirstNames.contains(name)) throw new DuplicateNameException(name, "The List<String> femaleFirstNames already contain " + name);
		...
		{
			if(maleFirstNames.contains(name)) throw new DuplicateNameException(name, "The List<String> maleFirstNames already contain " + name);
		...
		{
			if(lastNames.contains(lastName)) throw new DuplicateNameException(lastName, "The List<String> maleFirstNames already contain " + lastName);
